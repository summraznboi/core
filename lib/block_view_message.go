...
// TODO: Update for Postgres
func (bav *UtxoView) GetLimitedMessagesForUser(ownerPublicKey []byte, timestampKeyset uint64, limit uint64) (
	...
	dbMessageEntries, err := DBGetLimitedMessageForMessagingKeys(bav.Handle, messagingGroupEntries, timestampKeyset, limit)
	if err != nil {
